  ...
  return (
    <div className="h-full flex justify-center items-center">
      <h1 className="text-white text-4xl font-bold uppercase relative inline-block">
        <span id="before-te1" className="absolute top-0 left-0.5 w-full h-full bg-transparent" style={{ textShadow: "-2px 0 #fb9f00", clipPath: "rect(24px, 550px, 90px, 0)" }} aria-hidden="true">About me</span> {/* glitch::before */}
        About me
        <span id="after-te1" className="absolute top-0 -left-0.5 w-full h-full bg-transparent" style={{ textShadow: "-2px 0 spin(#fb9f00, 180)", clipPath: "rect(85px, 550px, 140px, 0)" }} aria-hidden="true">About me</span> {/* glitch::after */}
      </h1>
    </div>
  )
}
