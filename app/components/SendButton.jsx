...
const SendButton = () => {
  return (
    <div className="grid  place-content-center w-full bg-[#121212] p-4 ">
...
const DrawOutlineButton = ({ children, ...rest }) => {
  return (
    <button
      {...rest}
      className="group relative px-4 py-2 font-medium shadow-lg bg-[#121212] text-slate-100 transition-colors duration-[400ms] hover:text-white"
    >
      <span>{children}</span>
